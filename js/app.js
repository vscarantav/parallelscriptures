...
/* ================= TRANSLATE POPUP ===================================== */
// Wrap in DOMContentLoaded to ensure document.body exists
document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleSelection(e) {
    ...
    // Optional: Only allow inside verse container
    const container = document.getElementById("verse-container");
  ...
  document.addEventListener("keyup", (e) => {
      if (e.key.includes("Arrow") || e.key === "Shift") handleSelection(e);
  });
